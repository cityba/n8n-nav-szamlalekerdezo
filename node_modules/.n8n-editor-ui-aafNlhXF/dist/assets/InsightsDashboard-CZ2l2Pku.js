const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-BdmIslpa.js","assets/index-CH1Gwq1G.js","assets/index-BWpYwmXd.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-DudWdJDx.js","assets/chartjs.utils-CWQJCNeW.js","assets/InsightsSummary-w3WEmFKv.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-iDzwlMUB.js","assets/InsightsChartFailed-CKunAaEe.js","assets/InsightsChartFailureRate-DMp875IT.js","assets/InsightsChartTimeSaved-BVDmM3Jq.js","assets/InsightsChartAverageRuntime-By2eMwwf.js","assets/InsightsTableWorkflows-qGUEcwas.js","assets/N8nDataTableServer-IY1qu_eh.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cS as useModel, hH as useInsightsStore, r as ref, hX as UNLICENSED_TIME_RANGE, hL as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, cX as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, cW as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hY as ElDialog, am as usePageRedirectionHelper, _ as _export_sfc, a6 as useRoute, hZ as INSIGHT_TYPES, eW as defineAsyncComponent, ab as watch, o as onMounted, aj as useDocumentTitle, m as N8nHeading, n as normalizeClass, fx as _sfc_main$4, bY as resolveDynamicComponent, az as useTelemetry, h_ as TELEMETRY_TIME_RANGE, aJ as __vitePreload } from "./index-CH1Gwq1G.js";
import { I as InsightsSummary } from "./InsightsSummary-w3WEmFKv.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-BdmIslpa.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-DudWdJDx.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-CKunAaEe.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-DMp875IT.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BVDmM3Jq.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-By2eMwwf.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-qGUEcwas.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
