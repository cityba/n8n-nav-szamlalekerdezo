...
let CommandRegistry = class CommandRegistry {
    constructor(commandMetadata, moduleRegistry, logger) {
        this.commandMetadata = commandMetadata;
        this.moduleRegistry = moduleRegistry;
        this.logger = logger;
        this.argv = (0, yargs_parser_1.default)(process.argv.slice(2));
    ...
    parseFlags(commandEntry) {
        if (!commandEntry.flagsSchema)
            return {};
