...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./common", "./constants", "./errors", "./errors/application.error", "./expression", "./global-state", "./interfaces", "./node-helpers", "./node-parameters/rename-node-utils", "./node-reference-parser-utils", "./observable-object"], factory);
    }
    ...
    class Workflow {
        ...
        constructor(parameters) {
            ...
            this.connectionsByDestinationNode = (0, common_1.mapConnectionsByDestination)(parameters.connections);
         ...
         */
        getNode(nodeName) {
            return (0, common_1.getNodeByName)(this.nodes, nodeName);
        }
        /**
        ...
        getParentMainInputNode(node, visitedNodes = new Set()) {
            if (!node)
                return node;
            ...
            const nonMainConnectionTypes = Object.keys(nodeConnections).filter((type) => type !== interfaces_1.NodeConnectionTypes.Main);
                ...
                for (const connectionGroup of connections) {
                    for (const connection of connectionGroup ?? []) {
                        if (connection?.node) {
                            ...
                            if (!returnNode) {
                                throw new application_error_1.ApplicationError(`Node "${connection.node}" not found`);
                            }
         ...
         */
        hasPath(fromNodeName, toNodeName, maxDepth = 50) {
            ...
            for (const nodeConnections of Object.values(this.connectionsBySourceNode).concat(Object.values(this.connectionsByDestinationNode))) {
