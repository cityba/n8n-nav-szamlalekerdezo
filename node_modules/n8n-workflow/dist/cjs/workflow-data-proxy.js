...
(function (factory) {
    ...
    class WorkflowDataProxy {
        ...
        getNodeExecutionData(nodeName, shortSyntax = false, outputIndex, runIndex) {
            ...
            if (!shortSyntax) {
                ...
                if (!that.workflow.getNode(nodeName)) {
                    throw new expression_error_1.ExpressionError(expression_error_1.EXPRESSION_ERROR_MESSAGES.NODE_NOT_FOUND, {
                        messageTemplate: expression_error_1.EXPRESSION_ERROR_MESSAGES.NODE_REFERENCE_TEMPLATE,
                        runIndex: that.runIndex,
                        itemIndex: that.itemIndex,
                        nodeCause: nodeName,
                        descriptionKey: expression_error_1.EXPRESSION_DESCRIPTION_KEYS.NODE_NOT_FOUND,
                        type: expression_error_1.EXPRESSION_ERROR_TYPES.PAIRED_ITEM_NO_CONNECTION,
                    });
                }
                if (!that.runExecutionData.resultData.runData.hasOwnProperty(nodeName) &&
                    ...
                    throw new expression_error_1.ExpressionError(expression_error_1.EXPRESSION_ERROR_MESSAGES.NODE_NOT_FOUND, {
                        ...
                        itemIndex: that.itemIndex,
                        type: expression_error_1.EXPRESSION_ERROR_TYPES.PAIRED_ITEM_NO_CONNECTION,
                        descriptionKey: expression_error_1.EXPRESSION_DESCRIPTION_KEYS.NO_NODE_EXECUTION_DATA,
                        nodeCause: nodeName,
                    });
                }
                    ...
                    if (!node) {
                        throw new expression_error_1.ExpressionError(expression_error_1.EXPRESSION_ERROR_MESSAGES.NODE_NOT_FOUND, {
                            ...
                            descriptionKey: isScriptingNode(nodeName, that.workflow)
                                ? expression_error_1.EXPRESSION_DESCRIPTION_KEYS.PAIRED_ITEM_NO_CONNECTION_CODE_NODE
                                : expression_error_1.EXPRESSION_DESCRIPTION_KEYS.PAIRED_ITEM_NO_CONNECTION,
                            type: expression_error_1.EXPRESSION_ERROR_TYPES.PAIRED_ITEM_NO_CONNECTION,
                            nodeCause: nodeName,
                            runIndex: that.runIndex,
                            itemIndex: that.itemIndex,
                    ...
                    if (['binary', 'data', 'json'].includes(name)) {
                        ...
                        if (executionData.length === 0) {
                            if (that.workflow.getParentNodes(nodeName).length === 0) {
                                throw new expression_error_1.ExpressionError(expression_error_1.EXPRESSION_ERROR_MESSAGES.NO_EXECUTION_DATA, {
        ...
        getDataProxy(opts) {
            ...
            const createNodeReferenceError = (nodeCause) => {
                return createExpressionError(expression_error_1.EXPRESSION_ERROR_MESSAGES.NODE_NOT_FOUND, {
                    messageTemplate: expression_error_1.EXPRESSION_ERROR_MESSAGES.NODE_REFERENCE_TEMPLATE,
                    functionality: 'pairedItem',
                    descriptionKey: isScriptingNode(nodeCause, that.workflow)
                        ? expression_error_1.EXPRESSION_DESCRIPTION_KEYS.PAIRED_ITEM_NO_CONNECTION_CODE_NODE
            ...
            const getPairedItem = (destinationNodeName, incomingSourceData, initialPairedItem, usedMethodName = PAIRED_ITEM_METHOD.$GET_PAIRED_ITEM, nodeBeforeLast) => {
                ...
                if (matchedItems.length === 0) {
                    if (sourceArray.length === 0)
                        throw createNodeReferenceError(destinationNodeName);
                ...
                $input: new Proxy({}, {
                    ...
                    get(target, property, receiver) {
                        ...
                        if (that.connectionInputData.length === 0) {
                            throw createExpressionError(expression_error_1.EXPRESSION_ERROR_MESSAGES.NO_EXECUTION_DATA, {
                                runIndex: that.runIndex,
                                itemIndex: that.itemIndex,
                                type: 'no_execution_data',
                            });
