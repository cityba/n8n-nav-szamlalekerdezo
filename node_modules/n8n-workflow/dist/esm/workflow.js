...
import { getNodeByName, getConnectedNodes, getChildNodes, getParentNodes, mapConnectionsByDestination, } from './common';
...
export class Workflow {
    ...
    getParentMainInputNode(node, visitedNodes = new Set()) {
        ...
        const nonMainConnectionTypes = Object.keys(nodeConnections).filter((type) => type !== NodeConnectionTypes.Main);
